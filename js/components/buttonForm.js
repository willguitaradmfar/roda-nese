...
templates.buttonForm = (function () {
	...
	var templ = '<span type="button" class="btn btn-default" data-toggle="dropdown">Ok</span>'
				;

	var property = {};
	property.label = '';
	property.largura = 0;
	property.tipo = {val : 'default', options : ['success', 'info', 'danger', 'default', 'warning']};
	...
	var update = function (target, comp) {
		...
		$(target).attr('class', 'btn component '+'col-md-'+comp.property.largura+' btn-'+comp.property.tipo.val+' glyphicon glyphicon-'+comp.property.icone.val);		
