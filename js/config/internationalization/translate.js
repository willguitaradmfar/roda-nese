inject.define("config.internationalization.translate", [function () {
	...
	pt_br.grid.metacontext_context = 'Contexto';
	...
	pt_br.protheusSoap.metacontext_context = 'Contexto';
	
	pt_br.chartLine = {};
	pt_br.chartLine.metacontext_context = 'Contexto';
	...
	pt_br.chartBar = {};
	pt_br.chartBar.metacontext_context = 'Contexto';
	...
	pt_br.chartPie = {};
	pt_br.chartPie.metacontext_context = 'Contexto';
	...
	pt_br.chartPolarArea.metacontext_context = 'Contexto';
