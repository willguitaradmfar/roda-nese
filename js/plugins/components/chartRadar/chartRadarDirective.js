inject.define("plugins.components.chartRadar.chartRadarDirective", [function () {
    var self = {};
    
	self.scope = {};

	self.scope.radarChart = function() {
      var directiveDefinitionObject = {
         ...
         link: function(scope, element, attrs) {
            ...
            var chart = new Chart(ctx).Radar(getDatasets(scope.data), {
               animateScale: false
            });
            populate(scope.data);
